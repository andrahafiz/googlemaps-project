    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">Edit Layanan Rumah Sakit</h4>
            </div>
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Layanan Rumah Sakit</a></li>
                        <li class="breadcrumb-item active">Edit Layanan Rumah Sakit</li>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.layanan.update', $data->id_layanan) }}" method="POST">
                            @method('put')
                            {{ csrf_field() }}
                            <div class="form-body">
                                <h5 class="card-title">Form Layanan Rumah sakit</h5>
                                <hr>
                                <!--/row-->
                                <div class="row">
                                    {{-- <div class="col-md-6">
                                    ...
                                    <!--/span-->
                                    <div class="col-md-6">
                                        <div class="form-group @error('nama_layanan') error @enderror">
                                            <label>Nama Layanan</label>
                                            <input type="text" class="form-control" value="{{ $data->nama_layanan }}"
                                                name="nama_layanan">
                                            @error('nama_layanan')
