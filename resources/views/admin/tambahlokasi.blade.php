    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">Tambah Data Rumah Sakit</h4>
            </div>
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Lokasi Rumah Sakit</a></li>
                        <li class="breadcrumb-item active">Tambah Data Rumah Sakit</li>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.lokasi.store') }}" enctype="multipart/form-data" method="POST">
                            @method('post')
                            {{ csrf_field() }}
                            <div class="form-body">
                                    ...
                                    <div class="col-md-6 col-lg-6">
                                        ...
                                        {{-- <div class="col-lg-12"> --}}
                                            <div class="form-group @error('nama_rumahsakit') error @enderror">
                                                ...
                                                <input type="text" class="form-control" name="nama_rumahsakit">
                                            ...
                                            <div class="form-group @error('foto_rumahsakit') error @enderror">
                                                ...
                                                <input class="form-control" name="foto_rumahsakit"  id="image" type="file"   onchange="previewImage()"/>
                                            ...
                                            <div class="form-group @error('alamat_rumahsakit') error @enderror">
                                                ...
                                                <input type="text" class="form-control" name="alamat_rumahsakit">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6"> <div class="form-group @error('latitude_rumahsakit') error @enderror">
                                                    <label>Latitude</label>
                                                    <input type="text" class="form-control" name="latitude_rumahsakit" id="lat">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group @error('longitude_rumahsakit') error @enderror">
                                                        ...
                                                        <input type="text" class="form-control" name="longitude_rumahsakit" id="long">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" class="form-control"
                                                                name="informasi_layanan[]" name="informasi_rumahsakit"
...
<script async src="https://maps.googleapis.com/maps/api/js?key={{ env('GOOGLEMAP_API_KEY') }}&callback=initMap"></script>
